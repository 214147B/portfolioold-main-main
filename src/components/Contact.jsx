            ...
            <div className="w-full md:w-1/2 px-4 mb-8 md:mb-0">
              ...
              <ul className="text-white font-semibold">
                ...
                <li className="mb-4 flex items-center">
                  ...
                  <span>Kavinda Perera, Gurubabila, Mattihakka, Matale</span>
                </li>
                ...
                <li className="mb-4 flex items-center">
                  ...
                  <div>
                    <a href="tel:+94751676811" className="hover:text-gray-700">
                      +94 76 589 2649
                    </a>
                  </div>
                </li>
                ...
                <li className="mb-4 flex items-center">
                  ...
                  <a
                    href="mailto:savinduneth7@gmail.com"
                    className="hover:text-gray-700"
                  >
                    kavindpererakkp@gmail.com
                  </a>
                </li>
              </ul>
            </div>
